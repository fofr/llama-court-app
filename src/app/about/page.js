    ...
    <div>
      <div className="container max-w-4xl mx-auto md:px-8 px-4 py-4 pb-10 bg-white border-black min-h-screen">
        ...
        <div className="mx-8 text-lg mt-4 space-y-2">
          ...
          <p>
            Once an agent has spoken, all the other agents update their mood, beliefs, probability of guilty/innocent, and opinion about the current speaker. Then "speak eagerness" is computed again and another agent makes a statement. This process is repeated until all agents are certain of the defendant&#39;s guilt or innocence.
          </p>
          <p>
            The court transcript is generated by GPT-4 at the beginning of a session. The agent state is generated and updated by <a href="https://replicate.com/a16z-infra/llama-2-13b-chat" className="underline">Llama 2 13B-chat</a> running on Replicate.
          </p>
          <p>
